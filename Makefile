# This Makefile is for the Acme::LOLCAT extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Acme/LOLCAT.pm]
#     AUTHOR => q[Kent Cowgill <kent@c2group.net>]
#     LICENSE => q[perl]
#     NAME => q[Acme::LOLCAT]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Acme/LOLCAT.pm]
#     clean => { FILES=>q[Acme-LOLCAT-* blib pm_to_blib Makefile] }
...
TO_INST_PM = lib/Acme/LOLCAT.diff \
	lib/Acme/LOLCAT.pm

PM_TO_BLIB = lib/Acme/LOLCAT.diff \
	blib/lib/Acme/LOLCAT.diff \
	lib/Acme/LOLCAT.pm \
...
DISTNAME = Acme-LOLCAT
DISTVNAME = Acme-LOLCAT-0.0.4
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Acme/LOLCAT.pm $(INST_MAN3DIR)/Acme::LOLCAT.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                Acme-LOLCAT' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             0.0.4' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            SPEEK LIEK A LOLCATZ' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    - Kent Cowgill <kent@c2group.net>' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>SPEEK LIEK A LOLCATZ</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Kent Cowgill &lt;kent@c2group.net&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Acme/LOLCAT.diff blib/lib/Acme/LOLCAT.diff \
	  lib/Acme/LOLCAT.pm blib/lib/Acme/LOLCAT.pm 
